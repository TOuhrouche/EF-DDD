...
namespace EF_DDD {
    public class DddContext : Microsoft.EntityFrameworkCore.DbContext {
        ...
        public DddContext(string connectionString) : base()
        {
        ...
        public DddContext(DbConnection dbConnection) : base()
        {
